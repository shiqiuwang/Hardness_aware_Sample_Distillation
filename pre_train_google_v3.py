...
'''
@Time    : 2021/7/24 21:47
@Author  : Qiushi Wang
@FileName: pre_train_google_v3.py
@Software: PyCharm
'''
...
path_state_dict = './data/inception_v3_google-1a9a5a14.pth'
# num_classes = 100
...
num_ftrs_1 = alexnet_model.AuxLogits.fc.in_features
alexnet_model.AuxLogits.fc = nn.Linear(num_ftrs_1, num_classes)
...
# 将结果写入文本
# with open(file='./results/different_learning_method/random/googlenet/result/valid_acc.txt', mode='w+', encoding='utf-8') as f1:
#     for val in valid_acc:
#         f1.write(str(val))
#         f1.write('\n')
#
# with open(file='./results/different_learning_method/random/googlenet/result/valid_precision.txt', mode='w+', encoding='utf-8') as f2:
#     for val in valid_precision:
#         f2.write(str(val))
#         f2.write('\n')
#
# with open(file='./results/different_learning_method/random/googlenet/result/valid_recall.txt', mode='w+', encoding='utf-8') as f3:
#     for val in valid_recall:
#         f3.write(str(val))
#         f3.write('\n')
#
# with open(file='./results/different_learning_method/random/googlenet/result/valid_f1.txt', mode='w+', encoding='utf-8') as f4:
#     for val in valid_f1:
#         f4.write(str(val))
#         f4.write('\n')
#
# with open(file='./results/different_learning_method/random/googlenet/result/time_record.txt', mode='w+', encoding='utf-8') as f5:
#     for val in time_record:
#         f5.write(str(val))
#         f5.write('\n')
#
# with open(file='./results/different_learning_method/random/googlenet/result/train_acc.txt', mode='w+',
#           encoding='utf-8') as f6:
#     for val in train_acc:
#         f6.write(str(val))
#         f6.write('\n')
#
# with open(file='./results/different_learning_method/easy_to_hard/vgg/result/train_precision.txt', mode='w+',
#           encoding='utf-8') as f7:
#     for val in train_precision:
#         f7.write(str(val))
#         f7.write('\n')
#
# with open(file='./results/different_learning_method/easy_to_hard/vgg/result/train_recall.txt', mode='w+',
#           encoding='utf-8') as f8:
#     for val in train_recall:
#         f8.write(str(val))
#         f8.write('\n')
#
# with open(file='./results/different_learning_method/easy_to_hard/vgg/result/train_f1.txt', mode='w+',
#           encoding='utf-8') as f9:
#     for val in train_f1:
#         f9.write(str(val))
#         f9.write('\n')
#
# with open(file='./results/different_learning_method/easy_to_hard/vgg/result/train_time_record.txt', mode='w+',
