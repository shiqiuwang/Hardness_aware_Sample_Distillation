...
# 第0类
clf_0 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_0_loss_cur)
...
# 第1类
clf_1 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_1_loss_cur)
...
# 第2类
clf_2 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_2_loss_cur)
...
# 第3类
clf_3 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_3_loss_cur)
...
# 第4类
clf_4 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_4_loss_cur)
...
# 第5类
clf_5 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_5_loss_cur)
...
# 第6类
clf_6 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_6_loss_cur)
...
# 第7类
clf_7 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_7_loss_cur)
...
# 第8类
clf_8 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_8_loss_cur)
...
# 第9类
clf_9 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_9_loss_cur)
...
# 第10类
clf_10 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_10_loss_cur)
...
# 第11类
clf_11 = IsolationForest(random_state=0,contamination=0.05,max_samples=512).fit(label_11_loss_cur)
